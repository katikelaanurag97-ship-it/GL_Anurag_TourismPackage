...
DEFAULT_TRAIN_PATH = Path("/content/tourism_project/artifacts/train.csv")
DEFAULT_TEST_PATH = Path("/content/tourism_project/artifacts/test.csv")
MODEL_DIR = Path("/content/tourism_project/models")
REPORT_DIR = Path("/content/tourism_project/reports")
MLRUNS_DIR = Path("/content/tourism_project/mlruns")
TARGET = "ProdTaken"
